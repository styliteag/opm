...
COPY backend/scripts/fix_migration_revision.py ./scripts/fix_migration_revision.py
RUN chmod +x ./scripts/wait-for-db.py ./scripts/init_admin.py ./scripts/seed_nse.py ./scripts/fix_migration_revision.py
