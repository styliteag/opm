...
const GVM_SEVERITY_STYLES: Record<string, string> = {
...
function VulnerabilitiesTab({
  ...
  return (
    <div className="space-y-6">
      ...
      {gvmResults.length > 0 && (
        <div>
          <h4 className="text-sm font-emphasis text-foreground mb-3">
...
function GvmVulnRow({ vuln }: { vuln: Vulnerability }) {
  ...
  return (
    <div
      className="px-5 py-4 hover:bg-card cursor-pointer transition-colors"
