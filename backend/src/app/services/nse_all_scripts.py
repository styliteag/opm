"""Complete list of all NSE scripts shipped with nmap 7.98.

Used by the 'All Scripts Scan' builtin profile.
To regenerate: ls /usr/share/nmap/scripts/*.nse | xargs basename -a | sed 's/.nse$//' | sort
"""
ALL_NSE_SCRIPTS: list[str] = [
    "acarsd-info",
    "address-info",
    "afp-brute",
    "afp-ls",
